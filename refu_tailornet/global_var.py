...
DATA_DIR = '/home/qtan/TailorNet_dataset'

# Set the paths to SMPL model
SMPL_PATH_NEUTRAL = '/home/qtan/TailorNet_dataset/smpl/basicmodel_neutral_lbs_10_207_0_v1.1.0.pkl'
SMPL_PATH_MALE = '/home/qtan/TailorNet_dataset/smpl/basicmodel_m_lbs_10_207_0_v1.1.0.pkl'
SMPL_PATH_FEMALE = '/home/qtan/TailorNet_dataset/smpl/basicmodel_f_lbs_10_207_0_v1.1.0.pkl'

# Log directory where training logs, checkpoints and visualizations will be stored
# LOG_DIR = '/mnt/session_space/TailorNet/log'

LOG_DIR = '/home/qtan/TailorNet/log'

# Downloaded TailorNet trained models' path
MODEL_WEIGHTS_PATH = "/home/code-base/user_space/TailorNet_Models"
