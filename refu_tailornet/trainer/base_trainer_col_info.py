...
class Trainer(object):
    ...
    def load_dataset(self, split, collision_info = False):
        params = self.params
        dataset = MultiStyleShape(self.garment_class, split=split, gender=self.gender,
                                  smooth_level=params['smooth_level'], collision_info=collision_info)
...
def parse_argument():
    ...
    parser.add_argument('--log_name', default="tn_lf_100_1")
